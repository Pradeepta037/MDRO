...
from memoryGA import MemoryDNN
from optimization import bisection
from mainGA import plot_rate, save_to_txt
...
if __name__ == "__main__":
    ...
    n = 5000                     # number of time frames, <= 10,000
    K = N                   # initialize K = N
    decoder_mode = 'GA'    # the quantization mode could be 'OP' (Order-preserving) or 'KNN'
