...
# for tensorflow2
from memoryGB import MemoryDNN
...
if __name__ == "__main__":
    ...
    K = N                   # initialize K = N
    decoder_mode = 'GB'    # the quantization mode could be 'OP' (Order-preserving) or 'KNN'
    ...
    for i in range(n):
        ...
        m_pred = mem.decode(h, K, decoder_mode)
        ...
        mem.encode(h, m_pred[np.argmax(r_list)])
        ...
        K_his.append(K)
        mode_his.append(m_pred[np.argmax(r_list)])
